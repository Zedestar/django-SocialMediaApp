...
def home(request):
    ...
    if request.method == 'GET':
        ...
        if room_search_Query:
            rooms = Room.objects.filter(Q(topic__name__icontains = room_search_Query) | Q(name__icontains = room_search_Query) | Q(description__name__icontains = room_search_Query))
